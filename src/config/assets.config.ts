...
export const CDN_ASSETS = {
  ...
  weapon: {
    ...
    windSub: `${CDN_BASE_URL}/assets/weapon/wind-sub.png`, // 부채바람 진화 시 생기는 서브 무기 이미지
    // TODO: 에셋 준비되면 추가
  ...
  gui: {
    ...
    crown: `${CDN_BASE_URL}/assets/gui/crown.png`,
