...
#### 2. 금강저 (Vajra)
- **타입**: 궤도형 (Orbital)
- **공격 방식**: 플레이어 주변을 맴도는 무기
- **발동**: 지속적으로 회전하며 접촉 시 피해
- **업그레이드**:
  - 개수 증가 (최대 8개)
  - 크기 증가
  - 회전 속도 증가
...
#### 4. 먹물 공격 (Ink Blast)
- **타입**: 관통 투사체 (Piercing Beam)
- **공격 방식**: 일직선으로 방출되는 강력한 빔
- **발동**: 일정 간격으로 가장 가까운 적 방향으로 발사
- **업그레이드**:
  - 굵기 증가
  - 관통 횟수 증가
  - 피해량 증가
...
- [ ] 프로젝트 초기 설정 (PixiJS + TypeScript + Vite)
- [ ] 기본 플레이어 이동 시스템 (WASD 또는 방향키)
- [ ] 1-2가지 자동 공격 무기 구현 (부적, 금강저)
- [ ] 기본 적 AI (플레이어 추적)
- [ ] 적 스폰 시스템 (시간에 따라 증가)
- [ ] 경험치 및 레벨업 시스템
- [ ] 간단한 스킬 선택 UI
