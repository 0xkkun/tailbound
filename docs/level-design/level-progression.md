...
- 적 처치 시 경험치 젬 드랍
- 플레이어가 가까이 가면 자동 획득
- 획득 반경: 50픽셀 (XP_BALANCE.pickupRadius)
- 지속 시간: 120초(2분) 후 소멸
...
### 레벨업 시 선택지
매 레벨업마다 **3-4개 선택지** 중 1개 선택:

#### 선택지 타입
1. **새 무기 획득** (보유 무기 < 6개일 때)
...
- [ ] 레벨업 선택 UI (`LevelUpUI`) - **다음 구현 대상**

### 추가 구현
- [ ] 레벨업 이펙트 (파티클, 사운드)
- [x] 경험치 자석 효과 (범위 내 자동 흡수) - 50픽셀 범위
- [ ] 경험치 부스터 아이템
- [ ] 특별 레벨 보상 시스템
- [ ] 경험치 배율 시스템
